...
class SoloMPC(gym.Env):
    ...
    def reset(self):
        ...
        """self.q0[8] = np.random.uniform(0.7,0.9)
        self.q0[11] =np.random.uniform(0.7,0.9)
        self.q0[14] =  np.random.uniform(-0.9,-0.7)
        self.q0[17] =  np.random.uniform(-0.9,-0.7)
        self.q0[9] = np.random.uniform(-1.7,-1.5)
        self.q0[12]=np.random.uniform(-1.7,-1.5)
        self.q0[15]= np.random.uniform(1.5,1.7)
        self.q0[18]= np.random.uniform(1.5,1.7)
        """        
